...
npm install
npm run dev
 Disclaimer: This AI-generated advice is for educational and preliminary relief purposes only and is not a substitute for professional medical consultation.